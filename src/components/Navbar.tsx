...
export default function Navbar() {
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-4xl px-8 py-4 flex justify-between items-center backdrop-blur-2xl bg-black/90 border border-white/10 rounded-2xl shadow-2xl">
